...
export function CreditUsageBar({
  ...
  return (
    <div className="rounded-[24px] border border-[var(--border)] bg-white/72 px-5 py-5 shadow-[0_14px_30px_rgba(36,29,21,0.06)]">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="rounded-[18px] border border-[var(--border)] bg-[var(--background-elevated)] px-4 py-3">
